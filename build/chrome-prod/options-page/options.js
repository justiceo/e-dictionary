...
`;var mr=class extends So{constructor(u){super();this.configItems=u}checkboxTemplate(u){return Je`
    ...
    `}saveChange(u,v){console.log("saving: ",u,v),this.showToast()}showToast(){let u=this.renderRoot.querySelector("#liveToast");new $d.default.Toast(u).show()}};mr.styles=ln`
    ${Ld}
    ${Md}
  `,mr=md([jd("options-element")],mr);var Zs=class{render(m){console.log("rendering options: ",m);let u=new mr(m);document.body.appendChild(u)}},Wc=[{id:"disable-extension-on-site",type:"checkbox",title:"Temporarily disable extension",description:"Turns off the extension on all websites."},{id:"disable-sync",type:"checkbox",title:"Disable storage sync",description:"Your settings will not propagate to other browsers."},{id:"radio-id",type:"radio",title:"Sample radio title",description:"The detail information about the radio here."},{id:"switch-id",type:"switch",title:"Sample switch title",description:"The detail information about the switch here."},{id:"select-id",type:"select",title:"Sample select title",description:"The detail information about the select here."},{id:"range-id",type:"range",title:"Sample range title",description:"The detail information about the range here."},{id:"textarea-id",type:"textarea",title:"Sample textarea title",description:"The detail information about the textarea here."}],Vc=new Zs;Vc.render(Wc);})();
