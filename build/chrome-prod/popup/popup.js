...
`;var mr=class extends So{constructor(u){super();this.configItems=u}checkboxTemplate(u){return Je`
    ...
    `}saveChange(u,v){console.log("saving: ",u,v),this.showToast()}showToast(){let u=this.renderRoot.querySelector("#liveToast");new Md.default.Toast(u).show()}};mr.styles=ki`
    ${Pd}
  ...
  `,mr=cd([Dd("options-element")],mr);var Bc=new mr([{id:"disable-extension-on-site",type:"checkbox",title:"Disable extension on this site",description:"You will no longer see preview search results or view smart actions on this website"}]);document.body.appendChild(Bc);document.querySelector("#go-to-options").addEventListener("click",()=>{chrome.runtime.openOptionsPage?chrome.runtime.openOptionsPage():window.open(chrome.runtime.getURL("options.html"))});})();
